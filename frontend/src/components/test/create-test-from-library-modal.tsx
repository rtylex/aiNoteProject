    ...
    const handleCreateTest = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                let errorMessage = 'Test oluşturulamadı'
                if (contentType && contentType.includes('application/json')) {
                    ...
                    if (text.includes('<!DOCTYPE') || text.includes('<html')) {
                        errorMessage = 'Sunucu yanıtı okunamadı. İşlem çok uzun sürdü veya sunucu meşgul. Lütfen daha az soru deneyin veya daha sonra tekrar deneyin.'
                    } else if (text) {
